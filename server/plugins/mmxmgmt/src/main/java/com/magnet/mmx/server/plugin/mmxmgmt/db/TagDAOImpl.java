...
public class TagDAOImpl implements TagDAO {
  ...
  public int createUsernameTag(String tagname, String appId, String username) throws Exception {
    ...
    final String unboundStatementStr = "INSERT IGNORE INTO mmxTag (tagname, appId, creationDate, username) VALUES ('%s', '%s', '"+ new Timestamp(new java.util.Date().getTime()).toString()+"', '%s')";
    String statementStr = String.format(unboundStatementStr, tagname, appId, username, appId);
    Connection conn = null;
    PreparedStatement pstmt = null;
    try {
      conn = provider.getConnection();
  ...
  public int createDeviceTag(String tagname, String appId, String deviceId) throws Exception {
    ...
    final String unboundStatementStr = "INSERT IGNORE INTO mmxTag (tagname, appId, creationDate, deviceId) VALUES ('%s', '%s', '"+ new Timestamp(new java.util.Date().getTime()).toString()+"', (select id from mmxDevice where deviceId='%s' AND appId='%s'))";

    String statementStr = String.format(unboundStatementStr, tagname, appId, deviceId, appId);
    Connection conn = null;
    PreparedStatement pstmt = null;
  ...
  public int createDeviceTag(String tagname, String appId, int deviceIdFK) throws DbInteractionException {
    final String unboundStatementStr = "INSERT IGNORE INTO mmxTag (tagname, appId, creationDate, deviceId) VALUES ('%s', '%s', '"+ new Timestamp(new java.util.Date().getTime()).toString()+"', %d)";
    String statementStr = String.format(unboundStatementStr, tagname, appId, deviceIdFK, appId);
    Connection conn = null;
    PreparedStatement pstmt = null;
  ...
  public int createTopicTag(String tagname, String appId, String serviceId, String nodeId) throws DbInteractionException {
    ...
    final String unboundStatementStr = "INSERT IGNORE INTO mmxTag (tagname, appId, creationDate, serviceID, nodeID) VALUES ('%s', '%s', '"+ new Timestamp(new java.util.Date().getTime()).toString()+"', '%s', '%s')";
    LOGGER.trace("createTopicTag : tagname={}, appId={}, serviceId={}, nodeId={}", new Object[]{tagname, appId, serviceId, nodeId});

    String statementStr = String.format(unboundStatementStr, tagname, appId, serviceId, nodeId);
    Connection conn = null;
    PreparedStatement pstmt = null;
