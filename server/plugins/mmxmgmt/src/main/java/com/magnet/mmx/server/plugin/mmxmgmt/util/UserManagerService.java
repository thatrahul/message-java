...
public class UserManagerService {
  ...
  public static void createUser(MMXUserInfo userCreationInfo) throws UserAlreadyExistsException, ServerNotInitializedException {
    ...
    User newUser = getUserManager().createUser(userCreationInfo.getMMXUsername(), userCreationInfo.getPassword(),
  ...
  public static void deleteUser(MMXUserInfo userInfo) throws UserNotFoundException, ServerNotInitializedException{
    User user = getUserManager().getUser(userInfo.getMMXUsername());
  ...
  public static boolean updateUser(MMXUserInfo userCreationInfo) throws ServerNotInitializedException, UserNotFoundException {
    boolean created = false;
    try {
      User user = getUserManager().getUser(userCreationInfo.getMMXUsername());
