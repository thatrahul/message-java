...
public class MessageBuilder {
  ...
  public Message build() {
    ...
    String id = idGenerator.generate(userId, appEntity.getAppId(), deviceEntity != null ? deviceEntity.getDeviceId(): null);
    message.setID(id);
  ...
  private JID buildFromJID() {
    ...
    if (serverUser == null) {
      ...
      serverUser = MMXConfiguration.getConfiguration().getString(MMXConfigKeys.CONSOLE_MESSAGE_SEND_USER, "console");
    }
    //note: serverUser is stored with the appId suffix included.
