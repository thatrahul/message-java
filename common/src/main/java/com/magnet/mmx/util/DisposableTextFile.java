...
/**
 * This class allows the consumer of the text file to delete the file when the 
 ...
 * @see DisposableFile
 */
public class DisposableTextFile extends DisposableFile {
  private static final long serialVersionUID = 767802717197033889L;
   ...
   */
  public DisposableTextFile(File dir, String name, boolean deleteOnDone) {
   ...
   * @param deleteOnDone true to delete the file when done; otherwise, false.
   */
  public DisposableTextFile(String path, boolean deleteOnDone) {
   ...
   * @param deleteOnDone true to delete the file when done; otherwise, false.
   */
  public DisposableTextFile(String dirPath, String name, boolean deleteOnDone) {
   ...
   * @param deleteOnDone true to delete the file when done; otherwise, false.
   */
  public DisposableTextFile(URI uri, boolean deleteOnDone) {
