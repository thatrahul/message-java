...
public class TestApp {
  ...
  private final static String EC2 = "54.176.67.5";
  ...
  private void config(String host, String user, String pwd) throws MMXException {
    ...
    mSettings.setString(MMXSettings.PROP_EMAIL, user+"@magnet.com");
    mSettings.save();
  ...
  private void clone(String user, String pwd) throws MMXException {
    ...
    settings.setString(MMXSettings.PROP_NAME, 
        Character.toUpperCase(user.charAt(0))+user.substring(1).toLowerCase());
    settings.setString(MMXSettings.PROP_EMAIL, user+"@magnet.com");
...
//  }
  ...
  private void listSubs(String topic) throws MMXException {
    PubSubManager mgr = PubSubManager.getInstance(mCon);
    List<MMXSubscription> list = mgr.listSubscriptions(new MMXGlobalTopic(topic));
...
//  }
  ...
  private void help() {
    System.out.println(
        ...
        "     topicFetch topic since until, topicFetchall topic [sid]\n"+
        ...
        "     pingpong user devid, ping user devid, exit, ?");
  }
  ...
  private enum Command {
    ...
    stalk, unstalk, use, quit, exit, help, status,
