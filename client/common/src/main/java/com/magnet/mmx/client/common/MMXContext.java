...
public abstract class MMXContext {
  ...
  protected MMXContext() {
    XIDUtil.disableEsc(isEscEnabled());
  }
  /**
  ...
  /**
   * Is userID auto escaped by the underneath XMPP library?  It is called in the
   * constructor to initialize the XIDUtil.
   * @return
   */
  public abstract boolean isEscEnabled();
  /**
