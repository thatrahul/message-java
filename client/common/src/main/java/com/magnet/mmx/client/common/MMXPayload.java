...
public class MMXPayload implements Serializable {
   ...
   * is identifiable by the <code>dataType</code>.  Application can use
   * <code>dataType</code> to convert <code>textData</code> into an object.
   ...
   * is identifiable by the <code>dataType</code>.  Application can use
   * <code>dataType</code> to map the content in <code>fileData</code> to an
   * object.
   * @param type An identifier for the data content.
...
//  }
   ...
   * @hide
   */
  public CharSequence getTextData() {
   ...
   * @hide
   */
  public DisposableFile getFileData() {
    return mPayload.getFile();
  }
